...
fun.conf.urls = {
    ...
    alerts: '/alerts/',
    outbound: fun.utils.format('/outbound/%s', fun.conf.uuidOutbound),
    outbounds: '/outbound/',
...
fun.conf.templates = {
    ...
    headNavCalendars: fun.utils.format('%s/headNavCalendars.html', fun.conf.html),
    ...
    noContact: fun.utils.format('%s/noContact.html', fun.conf.html),
    contactItem: fun.utils.format('%s/contactItem.html', fun.conf.html),
    contactForm: fun.utils.format('%s/contactForm.html', fun.conf.html),
