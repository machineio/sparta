fun.views.profile = Backbone.View.extend({
    ...
    */
    ...
    editContact:function(event){
        ...
        var lead_id = this.$("#lead-id");
        var writing_agent = this.$("#writing-agent");
        var lead_first_name = this.$("#lead-first-name");
        var lead_middle_name = this.$("#lead-middle-name");
        var lead_last_name = this.$("#lead-last-name");
        var contact_info_writing_agent = this.$("#contact-info-writing-agent");
        var projected_individual_income = this.$("#projected-individual-income");
        var phone = this.$("#phone");
        var other_phone = this.$("#other-phone");
        var contact_info_first_name = this.$("#contact-info-first-name");
        var email = this.$("#email");
        var contact_info_last_name = this.$("#contact-info-last-name");
        var agent_code = this.$("#agent-code");
        var contact_info_lead_source = this.$("#contact-info-lead-source");
        var address_2 = this.$("#address-2");
        var city = this.$("#city");
        var state = this.$("#state");
        var health_current_premium = this.$("#health-current-premium");
        var contact_info_phone_number = this.$("#contact-info-phone-number");
        var contact_info_cellphone = this.$("#contact-info-cellphone");
        var created_date = this.$("#created-date");
        var contact_info_other_phone = this.$("#contact-info-other-phone");
        var date_modified = this.$("#date-modified");
        var contact_info_email = this.$("#contact-info-email");
        var marketplace_policy = this.$("#marketplace-policy");
        var additional_info_required = this.$("#additional-info-required");
        var health_lead_status = this.$("#health-lead-status");
        var currently_on_medicaid_or_medicare = this.$("#currently-on-medicaid-or-medicare");
        var scrubber = this.$("#scrubber");
        var health_agent_notes = this.$("#health-agent-notes");
        var do_you_have_medicaid_va_or_medicare = this.$("#do-you-have-medicaid-va-or-medicare");
        var contact_info_city = this.$("#contact-info-city");
        var contact_info_state = this.$("#contact-info-state");
        var contact_info_zip_code = this.$("#contact-info-zip-code");
        var contact_info_country = this.$("#contact-info-country");
        var lead_has_a_marketplace_account = this.$("#lead-has-a-marketplace-account");
        var spouse_dob = this.$("#spouse-dob");
        var child_1_dob = this.$("#child-1-dob");
        var child_2_dob = this.$("#child-2-dob");
        var self_employed = this.$("#self-employed");
        var gender = this.$("#gender");
        var marital_status = this.$("#marital-status");
        var contact_info_last_modified_by = this.$("#contact-info-last-modified-by");
        var renew_as_is_email_received = this.$("#renew-as-is-email-received");
        var spouse_last_name = this.$("#spouse-last-name");
        var spouse_gender = this.$("#spouse-gender");
        var spouse_social = this.$("#spouse-social");
        var child1_gender = this.$("#child1-gender");
        var child_2_gender = this.$("#child-2-gender");
        var credit_card_number_2016 = this.$("#credit-card-number-2016");
        var date_of_birth = this.$("#date-of-birth");
        var auto_priority_code = this.$("#auto-priority-code");
        var social_security_number = this.$("#social-security-number");
        var us_citizen_or_legal_permanent_resident = this.$("#us-citizen-or-legal-permanent-resident");
        var number_of_dependent_children_in_house = this.$("#number-of-dependent-children-in-house");
        var child_3_name = this.$("#child-3-name");
        var child_3_dob = this.$("#child-3-dob");
        var child_3_gender = this.$("#child-3-gender");
        var child_4_name = this.$("#child-4-name");
        var child_4_gender = this.$("#child-4-gender");
        var child_4_dob = this.$("#child-4-dob");
        var current_job_and_income_information = this.$("#current-job-and-income-information");
        var employment_status = this.$("#employment-status");
        var total_individual_income = this.$("#total-individual-income");
        var total_household_income = this.$("#total-household-income");
        var health_writing_agent = this.$("#health-writing-agent");
        var do_you_have_coverage_now = this.$("#do-you-have-coverage-now");
        var language_preference = this.$("#language-preference");
        var child_1_social = this.$("#child-1-social");
        var child_2_social = this.$("#child-2-social");
        var contact_info_child_1_name = this.$("#contact-info-child-1-name");
        var child_4_social = this.$("#child-4-social");
        var contact_info_child_2_name = this.$("#contact-info-child-2-name");
        var partner = this.$("#partner");
        var do_you_currently_have_insurance = this.$("#do-you-currently-have-insurance");
        var health_current_net_premium = this.$("#health-current-net-premium");
        var primary_applicants_employers_name = this.$("#primary-applicants-employers-name");
        var current_premium_2 = this.$("#current-premium-2");
        var health_adult_on_plan_2015 = this.$("#health-adult-on-plan-2015");
        ...
        var health_enrolledpaid_timestamp = this.$("#health-enrolledpaid-timestamp");
        var contact_info_child_1_dob = this.$("#contact-info-child-1-dob");
        var contact_info_child_2_dob = this.$("#contact-info-child-2-dob");
        var tcpa_compliant = this.$("#tcpa-compliant");
        var total_income_used_on_application = this.$("#total-income-used-on-application");
        var health_total_household_size_2016 = this.$("#health-total-household-size-2016");
        var health_premium_2015 = this.$("#health-premium-2015");
        var effective_date_2016 = this.$("#effective-date-2016");
        var contact_info_gender = this.$("#contact-info-gender");
        var contact_info_marital_status = this.$("#contact-info-marital-status");
        var contact_info_number_of_children = this.$("#contact-info-number-of-children");
        var cloud_premium_after_subsidy_2016 = this.$("#cloud-premium-after-subsidy-2016");
        var application_2016 = this.$("#application-2016");
        var cc_expiration_date_2016 = this.$("#cc-expiration-date-2016");
        var health_subsidy_2015 = this.$("#health-subsidy-2015");
        var health_children_on_plan_2015 = this.$("#health-children-on-plan-2015");
        var health_carrier_2015 = this.$("#health-carrier-2015");
        var health_current_coverage = this.$("#health-current-coverage");
        var final_premium_after_subsidy_2016 = this.$("#final-premium-after-subsidy-2016");
        var were_you_recently_released_from_jail = this.$("#were-you-recently-released-from-jail");
        var have_you_recently_gained_us_citizenship = this.$("#have-you-recently-gained-us-citizenship");
        var have_you_recently_moved = this.$("#have-you-recently-moved");
        var have_you_recently_had_a_baby = this.$("#have-you-recently-had-a-baby");
        var have_you_recently_gotten_married = this.$("#have-you-recently-gotten-married");
        var did_you_recently_get_divorced = this.$("#did-you-recently-get-divorced");
        var contact_info_renew_as_is_email_received = this.$("#contact-info-renew-as-is-email-received");
        var did_you_recently_get_divorced = this.$("#did-you-recently-get-divorced");
        var uninsured_looking_for_new_coverage = this.$("#uninsured-looking-for-new-coverage");
        var spouse_employers_phone_number = this.$("#spouse-employers-phone-number");
        var applicant_employers_phone_number = this.$("#applicant-employers-phone-number");
        var spouse_income_source = this.$("#spouse-income-source");
        var primary_applicants_income_source = this.$("#primary-applicants-income-source");
        var child_1_yearly_income = this.$("#child-1-yearly-income");
        var child_2_yearly_income = this.$("#child-2-yearly-income");
        var child_3_yearly_income = this.$("#child-3-yearly-income");
        var county = this.$("#county");
        var verification_documents_needed_2016 = this.$("#verification-documents-needed-2016");
        var bank_account_number_2016 = this.$("#bank-account-number-2016");
        var bank_routing_number_2016 = this.$("#bank-routing-number-2016");
        var bank_name_2016 = this.$("#bank-name-2016");
        var name_on_cc_2016 = this.$("#name-on-cc-2016");
        var cc_cvv_2016 = this.$("#cc-cvv-2016");
        var binder_payment_option_2016 = this.$("#binder-payment-option-2016");
        var dwelling_occupancy_2 = this.$("#dwelling-occupancy-2");
        var is_the_lead_interested_at_this_time_2 = this.$("#is-the-lead-interested-at-this-time-2");
        var cloud_gross_premium_2016 = this.$("#cloud-gross-premium-2016");
        var presold_processor_2016 = this.$("#presold-processor-2016");
        var renewal_agent_2016 = this.$("#renewal-agent-2016");
        var contact_info_child_1_gender = this.$("#contact-info-child-1-gender");
        var marketplace_policy_2016 = this.$("#marketplace-policy-2016");
        var health_policy_2016 = this.$("#health-policy-2016");
        var contact_info_child_2_gender = this.$("#contact-info-child-2-gender");
        var payment_credit_card_number = this.$("#payment-credit-card-number");
        var corrections_completed_2016 = this.$("#corrections-completed-2016");
        var paid_confirmation_number = this.$("#paid-confirmation-number");
        var contact_info_date_of_birth = this.$("#contact-info-date-of-birth");
        var health_auto_priority_code = this.$("#health-auto-priority-code");
        var contact_info_social_security_number = this.$("#contact-info-social-security-number");
        var ancillary_total_premium = this.$("#ancillary-total-premium");
        var health_number_of_dependent_children_in_house = this.$("#health-number-of-dependent-children-in-house");
        var contact_info_child_3_name = this.$("#contact-info-child-3-name");
        var contact_info_child_3_dob = this.$("#contact-info-child-3-dob");
        var contact_info_child_3_gender = this.$("#contact-info-child-3-gender");
        var contact_info_child_4_name = this.$("#contact-info-child-4-name");
        var contact_info_child_4_gender = this.$("#contact-info-child-4-gender");
        var contact_info_child_4_dob = this.$("#contact-info-child-4-dob");
        var hospital_confinement_requested_eff_date = this.$("#hospital-confinement-requested-eff-date");
        var accident_elite_requested_eff_date = this.$("#accident-elite-requested-eff-date");
        var critical_care_requested_eff_date = this.$("#critical-care-requested-eff-date");
        ...
        var health_total_household_income = this.$("#health-total-household-income");
        var subsidy_drop_off_date_new_2016 = this.$("#subsidy-drop-off-date-new-2016");
        var contact_info_language_preference = this.$("#contact-info-language-preference");
        var contact_info_child_1_social = this.$("#contact-info-child-1-social");
        var contact_info_child_2_social = this.$("#contact-info-child-2-social");
        var contact_info_child_3_social = this.$("#contact-info-child-3-social");
        var contact_info_child_4_social = this.$("#contact-info-child-4-social");
        var ancillary_bank_account_number_text = this.$("#ancillary-bank-account-number-text");
        var has_subsidy_dropped_off = this.$("#has-subsidy-dropped-off");
        var updated_premium_2016 = this.$("#updated-premium-2016");
        var marketplace_changed_premium = this.$("#marketplace-changed-premium");
        var health_marketplace_app_id_2015 = this.$("#health-marketplace-app-id-2015");
        var spouse_do_you_have_a_social_security_number = this.$("#spouse-do-you-have-a-social-security-number");
        var verification_documents_submitted_date = this.$("#verification-documents-submitted-date");
        var crosssell_tear_off_received = this.$("#crosssell-tear-off-received");
