fun.views.footer = Backbone.View.extend({
    ...
    events: {
        ...
        'change #contact-marital-status': 'changeMaritalStatus',
        'change #contact-home-insurance-checkbox': 'homeInsuranceTab',
        'change #contact-health-insurance-checkbox': 'healthInsuranceTab',
        'change #contact-auto-insurance-checkbox': 'autoInsuranceTab',
        'change #contact-life-insurance-checkbox': 'lifeInsuranceTab',
        'change #contact-ancilliary-insurance-checkbox': 'ancilliaryInsuranceTab',
        'change #contact-number-of-children': 'changeNumberChildren',
    ...
    initialize : function(options) {
        ...
        fun.omnibus.on("toronja:contact", function(){
            console.log('on toronja contact en el footer mae!');
        }, this);
    },
